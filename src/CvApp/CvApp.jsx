        ...
        return (
            <div>
                ...
                <footer className={classes.footer}>
                    <Typography align="center" gutterBottom style={styleCopyRight} variant="body1">
                        Copyright © 2018 Azger. All rights reserved.
                    </Typography>
                    <Typography align="center" gutterBottom style={styleCopyRight} variant="body1">
                        Made with React & Material - UI
                    </Typography>
                    <div className="app-footer-tools">
                        <svg className="app-footer-svg" viewBox="0 0 256 230" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet">
                        ...
                        <svg className="app-footer-svg" viewBox="0 0 600 476.6" xmlns="http://www.w3.org/2000/svg">
...
export default compose(withStyles(styles), withTheme())(CvApp);
